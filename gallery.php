...
<div class="container bgc-graym">
	<div>
		<span class="fs24 fc-white tp-font">GALLERY </span>
		...
		<div class="row text-center">
			<div class="col-xs-4">
				...
				<div class="fl sw300  fc-white  fs12 detail-left">
					...
					Luxury  Lobby 5-star hotel style
					...
					Game room
					<div class="space5"></div>
					Outdoor Jacuzzi, children's pool.
					<div class="space5"></div>
					Parking Key card system from the entrance 
					to the  room. Security 24 hours CCTV
				</div>
			</div>
